...
'Mozilla/5.0 (Linux; Android 7.1.2; GT-I9500 Build/NJH47F; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.139 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/391.1.0.37.104;])
...
def banner():
	cetak(panel(f"""\t[white]
\t[green] ______
\t[red]|  ___|__  _ __ ___ ___  
\t[white]| |_ / _ \| '__/ __/ _ \ || Multi Brute Force
\t[yellow]|  _| (_) | | | (_|  __/ || Developer OWI-XD
\t[white]|_|  \___/|_|  \___\___| || Version 1.8.7
             [bold white]Made By [bold red]Indonesian[cyan] LAILA [bold green]""",width=70,title=f"[bold green]• [bold yellow]• [bold red]• [bold white]LOGO BANNER [bold red]• [yellow]• [bold green]•",subtitle=f"[bold green]• [bold yellow]• [bold red]• [bold white]Version [bold green]0.1[/] [bold red]• [yellow]• [bold green]•",style=f"{color_table}"))
#--------------------[ BAGIAN-MASUK ]--------------#
def linex():
	print("%s══════════════════════════════════════════════════════════════════════%s"%(P,P))
